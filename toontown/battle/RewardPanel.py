#Embedded file name: toontown.battle.RewardPanel
import copy
import math
import random
...
class RewardPanel(DirectFrame):
    ...
    def __init__(self, name):
        ...
        DirectFrame.__init__(self, relief=None, geom=DGG.getDefaultDialogGeom(), geom_color=ToontownGlobals.GlobalDialogColor, geom_pos=Point3(0, 0, -0.05), geom_scale=gscale, pos=(0, 0, 0.587))
        ...
        for i in range(len(SuitDNA.suitDepts)):
            ...
            self.meritBars.append(DirectWaitBar(parent=self.gagExpFrame, relief=DGG.SUNKEN, frameSize=(-1, 1, -0.15, 0.15), borderWidth=(0.02, 0.02), scale=0.25, frameColor=(DisguisePage.DeptColors[i][0] * 0.7,
        ...
        for i in range(len(ToontownBattleGlobals.Tracks)):
            ...
            self.trackBars.append(DirectWaitBar(parent=self.gagExpFrame, relief=DGG.SUNKEN, frameSize=(-1, 1, -0.15, 0.15), borderWidth=(0.02, 0.02), scale=0.25, frameColor=(ToontownBattleGlobals.TrackColors[i][0] * 0.7,
