#Embedded file name: toontown.battle.MovieUtil
import random
...
def zapCog(suit, before, after, battle):
    ...
    flashTrack = Sequence(Wait(before), Func(suit.setColorScale, (0,
     0,
     0,
     1)), Func(insertZapSuit, suit, zapSuit, battle, suitPos, suitHpr), Func(zapSuit.setColorScale, (1,
     1,
     0,
     1)), Wait(0.2), Func(zapSuit.setColorScale, (1,
     1,
     1,
     1)), Wait(0.2), Func(zapSuit.setColorScale, (1,
     1,
     ...
     1,
     1,
     1)), Wait(0.2), Func(removeZapSuit, suit, zapSuit), Func(suit.setColorScale, (1,
     1,
     1,
     1)), Wait(after))
