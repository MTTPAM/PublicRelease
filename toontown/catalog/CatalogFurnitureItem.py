...
FurnitureTypes = {100: ('phase_5.5/models/estate/chairA', None, None, 80),
 ...
 490: ('phase_5.5/models/estate/tt_m_prp_int_fireplace_girlee', None, None, 1100, None, None, 0.5),
...
def nextAvailableBank(avatar, duplicateItems):
    if avatar.getMaxBankMoney not in MoneyToBank:
