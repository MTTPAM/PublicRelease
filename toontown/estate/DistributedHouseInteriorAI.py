#Embedded file name: toontown.estate.DistributedHouseInteriorAI
...
import random
houseInteriors = ['phase_5.5/dna/house_interior3.pdna',
...
defaultWindows = [CatalogWindowItem(20, placement=2), CatalogWindowItem(20, placement=4)]
defaultWallpaper = [CatalogWallpaperItem(1110, 0, 1010, 0),
...
class DistributedHouseInteriorAI(DistributedObjectAI):
    ...
    def initialize(self):
        ...
        furnitureReader = DNAFurnitureReaderAI(dnaData, [-11,
         2,
         0,
         0,
         0,
