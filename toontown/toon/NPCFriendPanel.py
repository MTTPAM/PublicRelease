            ...
            try:
                if track == 100:
                    ...
                    if level == -1:
                        ...
                        color = (ToontownBattleGlobals.TrackColors[level][0] * 0.8,
                         ToontownBattleGlobals.TrackColors[level][1] * 0.8,
                         ToontownBattleGlobals.TrackColors[level][2] * 0.8,
                         1)
                else:
                    color = (ToontownBattleGlobals.TrackColors[track][0] * 0.8,
