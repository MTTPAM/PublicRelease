#Embedded file name: toontown.toon.ExperienceBar
...
class ExperienceBar(DirectFrame):
    ...
    def load(self):
        if self.isToon:
            ...
            self.bgBar = DirectFrame(relief=None, geom=self.barGeom, pos=(0.0, 0, -0.95), geom_scale=(0.3, 0.25, 0.1), geom_color=self.color)
