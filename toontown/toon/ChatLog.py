...
class ChatLog(DirectFrame, DirectObject):
    ...
    def __init__(self):
        ...
        self.log = DirectScrolledList(parent=self, decButton_pos=(0.45, 0, 0.65), decButton_image=(gui.find('**/FndsLst_ScrollUp'),
         gui.find('**/FndsLst_ScrollDN'),
         gui.find('**/FndsLst_ScrollUp_Rllvr'),
         gui.find('**/FndsLst_ScrollUp')), decButton_relief=None, incButton_pos=(0.45, 0, -0.1475), incButton_image=(gui.find('**/FndsLst_ScrollUp'),
         gui.find('**/FndsLst_ScrollDN'),
         gui.find('**/FndsLst_ScrollUp_Rllvr'),
    ...
    def addToLog(self, msg, avId = 0):
        msg = msg.replace('\n', ' ')
        msgd = DirectButton(relief=None, text=msg, text_scale=0.035, text_pos=(-0.44, 0), text_style=3, text_align=TextNode.ALeft, text_wordwrap=25, text_shadow=(0, 0, 0, 1), command=self.buttonizeIt, extraArgs=[avId])
