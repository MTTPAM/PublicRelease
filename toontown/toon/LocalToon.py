#Embedded file name: toontown.toon.LocalToon
import math
import random
import re
import time
...
class LocalToon(DistributedToon.DistributedToon, LocalAvatar.LocalAvatar):
    ...
    def handleTunnelIn(self, startTime, endX, x, y, z, h):
        ...
        toonTrack.append(camera.posHprInterval(0.8, (0, -9 * scaleFactor, avHeight), (0, 0, 0), other=base.localAvatar, blendType='easeInOut'))
