#Embedded file name: toontown.toon.DistributedNPCToon
...
class DistributedNPCToon(DistributedNPCToonBase):
    ...
    def __init__(self, cr):
        ...
        self.questNotifyTypes = [base.loader.loadModel('phase_3/models/gui/quest_exclaim.bam'),
    ...
    def setMovie(self, mode, npcId, avId, quests, timestamp):
        ...
        if mode == NPCToons.QUEST_MOVIE_COMPLETE:
            ...
            fullString += TTLocalizer.QuestMovieExpJbReward % {'exp': experience,
             'money': money}
    ...
    def hasQuests(self):
        ...
        for quest in potentialQuests:
            ...
            for needed in questEntry[0]:
                if needed not in av.getQuestHistory():
