#Embedded file name: toontown.hood.CogHQAI
...
class CogHQAI:
    ...
    def __init__(self, air, zoneId, lobbyZoneId, lobbyFADoorCode, lobbyElevatorCtor, bossCtor):
        self.air = air
        self.zoneId = zoneId
    ...
    def createLobbyElevator(self):
        self.lobbyElevator = self.lobbyElevatorCtor(self.air, self.lobbyMgr, self.lobbyZoneId, antiShuffle=1)
