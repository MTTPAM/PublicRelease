...
class HoodAI:
    ...
    def createTreasurePlanner(self):
        ...
        self.treasurePlanner = SZTreasurePlannerAI(self.canonicalHoodId, treasureType, healAmount, spawnPoints, spawnRate, maxTreasures)
    ...
    def createBuildingManagers(self):
        for zoneId in self.getZoneTable():
            ...
            zoneId = ZoneUtil.getTrueZoneId(zoneId, self.zoneId)
            buildingManager = DistributedBuildingMgrAI.DistributedBuildingMgrAI(self.air, zoneId, dnaStore, self.air.trophyMgr)
