...
class SellbotHQAI(CogHQAI.CogHQAI):
    ...
    def __init__(self, air):
        CogHQAI.CogHQAI.__init__(self, air, ToontownGlobals.SellbotHQ, ToontownGlobals.SellbotLobby, FADoorCodes.SB_DISGUISE_INCOMPLETE, DistributedVPElevatorAI.DistributedVPElevatorAI, DistributedSellbotBossAI.DistributedSellbotBossAI)
    ...
    def createFactoryElevators(self):
        for i in xrange(2):
            factoryElevator = DistributedFactoryElevatorExtAI(self.air, self.air.factoryMgr, ToontownGlobals.SellbotFactoryInt, i)
