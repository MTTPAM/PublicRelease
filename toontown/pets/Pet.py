...
class Pet(Avatar.Avatar):
    ...
    def showMood(self, mood):
        ...
        Sequence(self.moodModel.scaleInterval(0.2, VBase3(1.1, 1.1, 1.1), blendType='easeInOut'), self.moodModel.scaleInterval(0.09, VBase3(1, 1, 1), blendType='easeInOut')).start()
