#Embedded file name: toontown.events.CharityScreen
...
class CharityScreen(DistributedObject):
    ...
    def __init__(self, cr):
        ...
        self.zone2pos = {ToontownGlobals.ToontownCentral: (40, 0, 25),
