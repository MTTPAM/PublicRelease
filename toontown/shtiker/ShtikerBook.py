...
class ShtikerBook(DirectFrame, StateData.StateData):
    ...
    def addPageTab(self, page, pageIndex, pageName = 'Page'):
        ...
        if pageIndex < self.numTabsPerSide:
            pageTab = DirectButton(parent=self.pageTabFrame, relief=DGG.RAISED, frameSize=(-0.575, 0.575, -0.575, 0.575), borderWidth=(0.05, 0.05), text=('',
             '',
             pageName,
            ...
            pageTab = DirectButton(parent=self.pageTabFrame2, relief=DGG.RAISED, frameSize=(-0.575, 0.575, -0.575, 0.575), borderWidth=(0.05, 0.05), text=('',
             '',
             pageName,
