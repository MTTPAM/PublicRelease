...
class MapPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        self.cloudScaleList = (((0.55, 0, 0.4),),
         (),
         ((0.45, 0, 0.45),),
         ((0.7, 0, 0.45),),
         ((0.55, 0, 0.4),),
        ...
        for hood in self.allZones:
            ...
            label = DirectButton(parent=self.map, relief=None, pos=self.labelPosList[hoodIndex], pad=(0.1, 0.08), text=('', fullname, fullname), text_bg=Vec4(1, 1, 1, 0.4), text_scale=0.055, text_wordwrap=8, rolloverSound=None, clickSound=None, pressEffect=0, command=self.__buttonCallback, extraArgs=[hood], sortOrder=1)
