#Embedded file name: toontown.shtiker.ItemsPage
...
class ItemsPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        self.nametagStyle_label = DirectLabel(parent=self, relief=None, text=TTLocalizer.ItemsPageNametagStyle, text_align=TextNode.ALeft, text_scale=0.054, text_wordwrap=16, pos=(leftMargin, 0, textStartHeight * 0.145 + 0.3))
        self.nametagStyle_preview = DirectLabel(parent=self, relief=None, text='Preview', scale=0.06, text_align=TextNode.ACenter, text_wordwrap=9, pos=(buttonbase_xcoord, 0, textStartHeight * 0.145 + 0.3))
        self.nametagStyle_leftButton = DirectButton(parent=self, relief=None, image=(gui.find('**/Horiz_Arrow_UP'),
         gui.find('**/Horiz_Arrow_DN'),
         gui.find('**/Horiz_Arrow_Rllvr'),
         gui.find('**/Horiz_Arrow_UP')), scale=-0.6, pos=(0.15, 0, textStartHeight * 0.145 + 0.3), command=self.__changeNametagStyle, extraArgs=[-1])
        self.nametagStyle_rightButton = DirectButton(parent=self, relief=None, image=(gui.find('**/Horiz_Arrow_UP'),
         gui.find('**/Horiz_Arrow_DN'),
         gui.find('**/Horiz_Arrow_Rllvr'),
         gui.find('**/Horiz_Arrow_UP')), scale=0.6, pos=(0.55, 0, textStartHeight * 0.145 + 0.3), command=self.__changeNametagStyle, extraArgs=[1])
        ...
        self.cheesyEffect_label = DirectLabel(parent=self, relief=None, text=TTLocalizer.ItemsPageCheesyEffect, text_align=TextNode.ALeft, text_scale=0.054, text_wordwrap=16, pos=(leftMargin, 0, textStartHeight * 0.145 - 0.3))
        self.cheesyEffect_preview = DirectLabel(parent=self, relief=None, text='Preview', scale=0.06, text_align=TextNode.ACenter, text_wordwrap=9, pos=(buttonbase_xcoord, 0, textStartHeight * 0.145 - 0.3))
        self.cheesyEffect_leftButton = DirectButton(parent=self, relief=None, image=(gui.find('**/Horiz_Arrow_UP'),
         gui.find('**/Horiz_Arrow_DN'),
         gui.find('**/Horiz_Arrow_Rllvr'),
         gui.find('**/Horiz_Arrow_UP')), scale=-0.6, pos=(0.15, 0, textStartHeight * 0.145 - 0.3), command=self.__changeCheesyEffect, extraArgs=[-1])
        self.cheesyEffect_rightButton = DirectButton(parent=self, relief=None, image=(gui.find('**/Horiz_Arrow_UP'),
         gui.find('**/Horiz_Arrow_DN'),
         gui.find('**/Horiz_Arrow_Rllvr'),
         gui.find('**/Horiz_Arrow_UP')), scale=0.6, pos=(0.55, 0, textStartHeight * 0.145 - 0.3), command=self.__changeCheesyEffect, extraArgs=[1])
