#Embedded file name: toontown.shtiker.TrackPage
...
class TrackPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        for track in xrange(len(ToontownBattleGlobals.Tracks)):
            ...
            self.trackProgressLabels.append(DirectLabel(text='', parent=self.trackRows[track], pos=(-0.78825, -0.1, -0.025), scale=TTLocalizer.INtrackNameLabels / 2, relief=None, text_fg=(0.2, 0.2, 0.2, 1), text_font=ToontownGlobals.getInterfaceFont(), text_align=TextNode.ALeft, textMayChange=0))
            self.buttons.append([])
