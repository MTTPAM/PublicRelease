#Embedded file name: toontown.shtiker.OptionsPage
...
class OptionsPage(ShtikerPage.ShtikerPage, DirectObject):
    ...
    def load(self):
        ...
        self.title = DirectLabel(parent=self, relief=None, text=TTLocalizer.OptionsPageTitle, text_scale=0.05, pos=(0, 0, 0.65))
...
class OptionsTabPage(DirectFrame):
    ...
    def load(self):
        ...
        self.Music_toggleSlider = DirectSlider(self.soundNode, pos=(buttonbase_xcoord, 0.0, buttonbase_ycoord), value=settings['musicVol'] * 100, pageSize=5, range=(0, 100), command=self.__doMusicLevel, thumb_geom=guiButton.find('**/QuitBtn_UP'), thumb_relief=None, thumb_geom_scale=1)
        self.Music_toggleSlider.setScale(0.25)
        self.SoundFX_toggleSlider = DirectSlider(self.soundNode, pos=(buttonbase_xcoord, 0.0, buttonbase_ycoord - textRowHeight), value=settings['sfxVol'] * 100, pageSize=5, range=(0, 100), command=self.__doSfxLevel, thumb_geom=guiButton.find('**/QuitBtn_UP'), thumb_relief=None, thumb_geom_scale=1)
        ...
        self.tpMessages_Label = DirectLabel(parent=self.privacyNode, relief=None, text='', text_align=TextNode.ALeft, text_scale=options_text_scale, text_wordwrap=16, pos=(leftMargin, 0, textStartHeight - 2 * textRowHeight))
        self.tpMessages_toggleButton = DirectButton(parent=self.privacyNode, relief=None, image=(guiButton.find('**/QuitBtn_UP'), guiButton.find('**/QuitBtn_DN'), guiButton.find('**/QuitBtn_RLVR')), image_scale=button_image_scale, text='', text_scale=options_text_scale, text_pos=button_textpos, pos=(buttonbase_xcoord, 0.0, buttonbase_ycoord - 2 * textRowHeight), command=self.__doToggleTpMessages)
        self.friendMessages_Label = DirectLabel(parent=self.privacyNode, relief=None, text='', text_align=TextNode.ALeft, text_scale=options_text_scale, text_wordwrap=16, pos=(leftMargin, 0, textStartHeight - 3 * textRowHeight))
        self.friendMessages_toggleButton = DirectButton(parent=self.privacyNode, relief=None, image=(guiButton.find('**/QuitBtn_UP'), guiButton.find('**/QuitBtn_DN'), guiButton.find('**/QuitBtn_RLVR')), image_scale=button_image_scale, text='', text_scale=options_text_scale, text_pos=button_textpos, pos=(buttonbase_xcoord, 0.0, buttonbase_ycoord - 3 * textRowHeight), command=self.__doToggleFriendMessages)
        ...
        self.speedChatStyleLeftArrow = DirectButton(self.displayNode, relief=None, image=(gui.find('**/Horiz_Arrow_UP'),
         ...
         gui.find('**/Horiz_Arrow_UP')), image3_color=Vec4(1, 1, 1, 0.5), scale=(-1.0, 1.0, 1.0), pos=(0.25, 0, buttonbase_ycoord - textRowHeight), command=self.__doSpeedChatStyleLeft)
        self.speedChatStyleRightArrow = DirectButton(self.displayNode, relief=None, image=(gui.find('**/Horiz_Arrow_UP'),
         gui.find('**/Horiz_Arrow_DN'),
         gui.find('**/Horiz_Arrow_Rllvr'),
         gui.find('**/Horiz_Arrow_UP')), image3_color=Vec4(1, 1, 1, 0.5), pos=(0.65, 0, buttonbase_ycoord - textRowHeight), command=self.__doSpeedChatStyleRight)
        ...
        self.speedChatStyleText.setPos(buttonbase_xcoord, 0, buttonbase_ycoord - textRowHeight + 0.03)
        self.newGui_Label = DirectLabel(parent=self.displayNode, relief=None, text='', text_align=TextNode.ALeft, text_scale=options_text_scale, text_wordwrap=16, pos=(leftMargin, 0, textStartHeight - 2 * textRowHeight))
        self.newGui_toggleButton = DirectButton(parent=self.displayNode, relief=None, image=(guiButton.find('**/QuitBtn_UP'), guiButton.find('**/QuitBtn_DN'), guiButton.find('**/QuitBtn_RLVR')), image_scale=button_image_scale, text='', text_scale=options_text_scale, text_pos=button_textpos, pos=(buttonbase_xcoord, 0.0, buttonbase_ycoord - 2 * textRowHeight), command=self.__doToggleNewGui)
        ...
        self.fov_toggleSlider = DirectSlider(parent=self.displayNode, pos=(buttonbase_xcoord, 0.0, buttonbase_ycoord - 3 * textRowHeight), value=settings['fieldofview'], pageSize=5, range=(30, 120), command=self.__doFovLevel, thumb_geom=guiButton.find('**/QuitBtn_UP'), thumb_relief=None, thumb_geom_scale=1)
        ...
        self.animations_Label = DirectLabel(parent=self.displayNode, relief=None, text='', text_align=TextNode.ALeft, text_scale=options_text_scale, text_wordwrap=16, pos=(leftMargin, 0, textStartHeight - 6 * textRowHeight))
        self.animations_toggleButton = DirectButton(parent=self.displayNode, relief=None, image=(guiButton.find('**/QuitBtn_UP'), guiButton.find('**/QuitBtn_DN'), guiButton.find('**/QuitBtn_RLVR')), image_scale=button_image_scale, text='', text_scale=options_text_scale, text_pos=button_textpos, pos=(buttonbase_xcoord, 0.0, buttonbase_ycoord - 6 * textRowHeight), command=self.__doToggleAnimations)
        ...
        self.keymapDialogButton.setScale(1.395, 0.9, 0.9)
        self.interactKey_Label = DirectLabel(self.controlsNode, relief=None, text='', text_align=TextNode.ALeft, text_scale=options_text_scale, text_wordwrap=16, pos=(leftMargin, 0, textStartHeight - 2 * textRowHeight))
        self.interactKey_toggleButton = DirectButton(self.controlsNode, relief=None, image=(guiButton.find('**/QuitBtn_UP'), guiButton.find('**/QuitBtn_DN'), guiButton.find('**/QuitBtn_RLVR')), image_scale=button_image_scale, text='', text_scale=options_text_scale, text_pos=button_textpos, pos=(buttonbase_xcoord, 0.0, buttonbase_ycoord - 2 * textRowHeight), command=self.__doToggleInteractKey)
        self.doorKey_Label = DirectLabel(self.controlsNode, relief=None, text='', text_align=TextNode.ALeft, text_scale=options_text_scale, text_wordwrap=16, pos=(leftMargin, 0, textStartHeight - 3 * textRowHeight))
        self.doorKey_toggleButton = DirectButton(self.controlsNode, relief=None, image=(guiButton.find('**/QuitBtn_UP'), guiButton.find('**/QuitBtn_DN'), guiButton.find('**/QuitBtn_RLVR')), image_scale=button_image_scale, text='', text_scale=options_text_scale, text_pos=button_textpos, pos=(buttonbase_xcoord, 0.0, buttonbase_ycoord - 3 * textRowHeight), command=self.__doToggleDoorKey)
