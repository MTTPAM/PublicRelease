#Embedded file name: toontown.shtiker.CodePage
import ShtikerPage
...
class CodePage(ShtikerPage.ShtikerPage):
    ...
    def __getCodeResult(self, result, awardMgrResult):
        ...
        Sequence(self.resultPanel.scaleInterval(0.2, VBase3(1.1, 1.1), blendType='easeInOut'), self.resultPanel.scaleInterval(0.12, VBase3(1, 1), blendType='easeInOut')).start()
        if result == 0:
    ...
    def __hideResultPanel(self):
        Sequence(self.resultPanel.scaleInterval(0.12, VBase3(1.1, 1.1), blendType='easeInOut'), self.resultPanel.scaleInterval(0.2, VBase3(0, 0), blendType='easeInOut'), Func(self.resultPanel.hide)).start()
