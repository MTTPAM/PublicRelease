#Embedded file name: toontown.shtiker.SuitPage
...
SCALE_FACTOR = 1.5
RADAR_DELAY = 0.2
BUILDING_RADAR_POS = (0.4, 0.1, -0.18, -0.5, -0.51)
...
SHADOW_SCALE_POS = ((1.225, 0, 10, -0.03),
 (0.9, 0, 10, 0),
 (1.125, 0, 10, -0.015),
 (1.0, 0, 10, -0.02),
 (1.0, -0.02, 10, -0.01),
...
class SuitPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        self.moneyRadarButton = DirectButton(parent=self.iconNode, relief=None, state=DGG.DISABLED, image=(icon, icon, icon), image_scale=(0.03375, 1, 0.045), image2_color=Vec4(1.0, 1.0, 1.0, 0.75), pos=(-0.2, 10, -0.46), command=self.toggleRadar, extraArgs=[2])
    ...
    def makePanels(self):
        ...
        for dept in xrange(0, len(SuitDNA.suitDepts)):
            ...
            for type in xrange(0, SuitDNA.suitsPerDept):
                ...
                panel.hoverButton = DirectButton(parent=panel, relief=None, image_scale=(0.15, 0, 0.18), image='phase_3/maps/invisible.png', pressEffect=0)
