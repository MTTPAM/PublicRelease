#Embedded file name: toontown.achievements.AchievementGui
...
class AchievementGui(DirectFrame):
    ...
    def displayAchievement(self):
        ...
        self.frame = DirectFrame(relief=None, geom='phase_3/models/gui/dialog_box_gui', geom_scale=(1.5, 0.5, 0.5), scale=(1, 1, 1), parent=self, pos=(0, 0, 0.7))
