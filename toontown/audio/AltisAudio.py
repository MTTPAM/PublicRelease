#Embedded file name: toontown.audio.AltisAudio
...
class AltisAudio:
    ...
    def fadeOutMusic(self, musicFile):
        Sequence(LerpFunctionInterval(musicFile.setVolume, fromData=1, toData=0, duration=1), Func(musicFile.stop)).start()
