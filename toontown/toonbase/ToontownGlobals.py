...
CogSuitHPLevels = (14,
 ...
 39,
 49)
CogReviveSuitHPLevels = (24, 49)
ExperienceTrainingPointLevels = (3,
 7,
 11,
 15,
 19,
...
HoodHierarchy = {ToontownCentral: (SillyStreet,
                   LoopyLane,
                   PunchlinePlace,
                   WackyWay),
 DonaldsDock: (BarnacleBoulevard,
               SeaweedStreet,
               LighthouseLane,
               AhoyAvenue),
 TheBrrrgh: (WalrusWay, SleetStreet, PolarPlace),
 MinniesMelodyland: (AltoAvenue,
                     BaritoneBoulevard,
                     TenorTerrace,
                     SopranoStreet),
 DaisyGardens: (ElmStreet,
                MapleStreet,
                OakStreet,
                RoseValley),
 OutdoorZone: (AcornAvenue,
               PeanutPlace,
               WalnutWay,
               LegumeLane),
...
CashbotMintSkelecogLevel = 14
CashbotMintBossLevel = 18
...
BossbotCountryClubSkelecogLevel = 14
...
LawbotStageSkelecogLevel = 14
LawbotStageBossLevel = 18
...
suitIndex = {'f': 0,
 ...
 'bfh': 38,
 'hho': 39}
BossCogRollSpeed = 20.0
BossCogTurnSpeed = 40
BossCogTreadSpeed = 25.5
BossCogDizzy = 0
...
BossCogDamageLevels = {BossCogElectricFence: 1,
 ...
 BossCogRecoverDizzyAttack: 15,
 BossCogDirectedAttack: 3,
 BossCogStrafeAttack: 2,
 BossCogGoonZap: 5,
 BossCogSlowDirectedAttack: 24,
 BossCogGavelStomp: 40,
 BossCogGavelHandle: 15,
 BossCogLawyerAttack: 15,
 BossCogMoveAttack: 20,
 BossCogGolfAttack: 25,
 BossCogGolfAreaAttack: 25,
...
LawbotBossWinningTilt = 45
LawbotBossInitialDamage = 1350
LawbotBossBattleOnePosHpr = (-2.798, 20, 0, 0, 0, 0)
LawbotBossBattleTwoPosHpr = (-2.798, 85, 19, 0, 0, 0)
LawbotBossTopRampPosA = (-80, -35, 18)
LawbotBossTopRampTurnPosA = (-80, 10, 18)
LawbotBossP3PosA = (55, -9, 50)
...
LawbotBossCogJurorFlightTime = 30
LawbotBossCogJurorDistance = 75
LawbotBossBaseJurorNpcId = 2001
LawbotBossWitnessEpiloguePosHpr = (-3, 0, 0, 180, 0, 0)
LawbotBossChanceForTaunt = 70
LawbotBossBonusWaitTime = 60
LawbotBossBonusDuration = 60
LawbotBossBonusToonup = 100
LawbotBossBonusWeightMultiplier = 50
LawbotBossChanceToDoAreaAttack = 30
LawbotBossChanceToDoGolfAreaAttack = 30
LOW_POP_JP = 0
MID_POP_JP = 100
HIGH_POP_JP = 200
LOW_POP_INTL = 399
...
BossbotRTIntroStartPosHpr = (0, -44, 0, 180, 0, 0)
...
BossbotFoodModelScale = 1.0
BossbotNumFoodToExplode = 2
BossbotBossServingDuration = 300
BossbotPrepareBattleThreeDuration = 20
WaiterBattleAPosHpr = (20, -20, 0, 45, 0, 0)
WaiterBattleBPosHpr = (-20, -20, 0, -45, 0, 0)
BossbotBossBattleThreePosHpr = (0, 355, 0, 0, 0, 0)
DinerBattleAPosHpr = (15, -330, 0, 180, 0, 0)
DinerBattleBPosHpr = (-15, -330, 0, 180, 0, 0)
BossbotBossMaxDamage = 500
BossbotMaxSpeedDamage = 90
BossbotSpeedRecoverRate = 50
BossbotBossDifficultySettings = [(8, 4, 8, 3, 30, 25),
 (9, 5, 9, 6, 28, 26),
 (10, 6, 12, 7, 26, 27),
 (8, 8, 11, 8, 24, 28),
 (13, 5, 10, 9, 22, 29)]
BossbotBossDamageMultipliers = [1,
 1.2,
 1.4,
 1.6,
 1.8]
...
RegenLaffDict = {ToontownCentral: 1,
 ...
 TheBrrrgh: 6,
 DonaldsDreamland: 7}
HouseInteriorLayoutPrices = [4000,
 5000,
 6000,
 7000]
CODE_SUCCESS = 0
