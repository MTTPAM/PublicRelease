...
class ToonBase(OTPBase.OTPBase):
    ...
    def __init__(self):
        ...
        self.camLens.setMinFov(settings['fieldofview'] / (4.0 / 3.0))
        ...
        self.showDisclaimer = settings.get('show-disclaimer', True)
    ...
    def takeScreenShot(self):
        ...
        self.screenShotNotice = DirectLabel(text='Screenshot Saved:\n' + winfile, scale=0.05, pos=(0.0, 0.0, 0.3), text_bg=(0, 0, 0, 0.4), text_fg=(1, 1, 1, 1), frameColor=(1, 1, 1, 0))
    ...
    def initNametagGlobals(self):
        ...
        NametagGlobals.setPageButton(chatButtonGui.find('**/Horiz_Arrow_UP'), chatButtonGui.find('**/Horiz_Arrow_DN'), chatButtonGui.find('**/Horiz_Arrow_Rllvr'), chatButtonGui.find('**/Horiz_Arrow_UP'))
        NametagGlobals.setQuitButton(chatButtonGui.find('**/CloseBtn_UP'), chatButtonGui.find('**/CloseBtn_DN'), chatButtonGui.find('**/CloseBtn_Rllvr'), chatButtonGui.find('**/CloseBtn_UP'))
        ...
        self.leftCells = [self.marginManager.addCell(0.1, -0.6, self.a2dTopLeft, 1), self.marginManager.addCell(0.1, -1.0, self.a2dTopLeft, 2), self.marginManager.addCell(0.1, -1.4, self.a2dTopLeft, 3)]
        self.bottomCells = [self.marginManager.addCell(0.4, 0.1, self.a2dBottomCenter, 4),
        ...
        self.rightCells = [self.marginManager.addCell(-0.1, -0.6, self.a2dTopRight, 8), self.marginManager.addCell(-0.1, -1.0, self.a2dTopRight, 9), self.marginManager.addCell(-0.1, -1.4, self.a2dTopRight, 10)]
