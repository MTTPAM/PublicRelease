#Embedded file name: toontown.environment.DistributedRainManager
...
class DistributedRainManager(DistributedWeatherMGR):
    ...
    def spawnLightning(self, x, y):
        Sequence(Func(render.setColorScale, 1, 1, 1, 1), Wait(0.2), Func(render.setColorScale, 0.6, 0.6, 0.6, 1)).start()
