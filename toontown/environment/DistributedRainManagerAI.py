#Embedded file name: toontown.environment.DistributedRainManagerAI
...
class DistributedRainManagerAI(DistributedWeatherMGRAI):
    ...
    def announceGenerate(self):
        ...
        if self.zoneId in (3000, 3100, 3200, 3300):
            ...
            rainState = 'Rain'
        Sequence(Func(self.b_setState, 'Sunny'), Wait(1800), Func(self.b_setState, rainState), Wait(900)).loop()
