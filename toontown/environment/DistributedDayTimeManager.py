#Embedded file name: toontown.environment.DistributedDayTimeManager
...
class DistributedDayTimeManager(DistributedWeatherMGR):
    ...
    def update(self, currentHour):
        self.currSeq = LerpColorScaleInterval(render, self.interval, DayTimeGlobals.COLORS[0 if currentHour == 23 else currentHour + 1], DayTimeGlobals.COLORS[currentHour])
        self.currSeq.start()
