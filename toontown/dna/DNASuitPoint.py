#Embedded file name: toontown.dna.DNASuitPoint


class DNASuitPoint(object):
    __slots__ = ('index', 'pointType', 'pos', 'graphId', 'landmarkBuildingIndex')
    COMPONENT_CODE = 20
    ...
    def __str__(self):
        ...
        return 'DNASuitPoint index: %d, pointType: %s, pos: %s' % (self.getIndex(), pointTypeStr, self.getPos())
