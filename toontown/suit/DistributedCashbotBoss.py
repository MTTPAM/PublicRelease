...
class DistributedCashbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def announceGenerate(self):
        ...
        self.titleText = OnscreenText('Vaultbot Vault\nThe V.S.S. 2.0', fg=(1, 1, 1, 1), shadow=(0, 0, 0, 1), font=ToontownGlobals.getSuitFont(), pos=(0, -0.5), scale=0.16, drawOrder=0, mayChange=1)
        self.titleText.hide()
        if OneBossCog != None:
    ...
    def makeIntroductionMovie(self, delayDeletes):
        ...
        track = Sequence(base.camera.posHprInterval(1, Point3(82, -219, 5), VBase3(267, 0, 0)), Func(rToon.setChatAbsolute, TTL.ResistanceToonWelcome, CFSpeech), Wait(3), Sequence(goonTrack, duration=0), Parallel(base.camera.posHprInterval(4, Point3(108, -244, 4), VBase3(211.5, 0, 0), blendType='easeInOut'), Sequence(Func(rToon.suit.setPlayRate, 1.4, 'walk'), Func(rToon.suit.loop, 'walk'), Parallel(rToon.hprInterval(1, VBase3(180, 0, 0)), rToon.posInterval(3, VBase3(120, -255, 0)), Sequence(Wait(2), Func(rToon.clearChat))), Func(rToon.suit.loop, 'neutral'), self.door2.posInterval(3, VBase3(0, 0, 30)))), Func(rToon.setHpr, 0, 0, 0), Func(rToon.setChatAbsolute, TTL.ResistanceToonTooLate, CFSpeech), Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, 61.1, -228.8, 10.2, 270, 0, 0), self.door1.posInterval(2, VBase3(0, 0, 30)), Parallel(bossTrack, Sequence(Wait(3), Func(rToon.clearChat), self.door1.posInterval(3, VBase3(0, 0, 0)))), base.camera.posHprInterval(1, Point3(93.3, -230, 0.7), VBase3(268.9, 39.7, 8.3), blendType='easeInOut'), Func(self.titleSeq.start), Func(self.setChatAbsolute, TTL.CashbotBossDiscoverToons1, CFSpeech), LerpColorScaleInterval(render, 1, Vec4(0.75, 1.0, 0.75, 1.0)), Func(self.setChatAbsolute, TTL.CashbotBossDiscoverToons2, CFSpeech), Wait(4), Func(self.clearChat), self.loseCogSuits(self.toonsA + self.toonsB, render, (113, -228, 10, 90, 0, 0)), Wait(1), Func(rToon.setHpr, 0, 0, 0), self.loseCogSuits([rToon], render, (133, -243, 5, 143, 0, 0), True), Func(rToon.setChatAbsolute, TTL.ResistanceToonKeepHimBusy, CFSpeech), Wait(1), Func(self.__showResistanceToon, False), Sequence(Func(rToon.animFSM.request, 'run'), rToon.hprInterval(1, VBase3(180, 0, 0)), Parallel(Sequence(rToon.posInterval(1.5, VBase3(109, -294, 0)), Parallel(Func(rToon.animFSM.request, 'jump')), rToon.posInterval(1.5, VBase3(93.935, -341.065, 2))), self.door2.posInterval(3, VBase3(0, 0, 0))), Func(rToon.animFSM.request, 'neutral')), self.toonNormalEyes(self.involvedToons), self.toonNormalEyes([self.resistanceToon], True), Func(rToon.clearChat), base.camera.posHprInterval(2, Point3(93.3, -230, 0.7), VBase3(268.9, 39.7, 8.3), blendType='easeInOut'), Func(self.setChatAbsolute, attackToons, CFSpeech), Wait(2), Func(self.clearChat))
    ...
    def makePrepareBattleTwoMovie(self, delayDeletes):
        ...
        track = Sequence(Parallel(self.door2.posInterval(4.5, VBase3(0, 0, 30)), self.door3.posInterval(4.5, VBase3(0, 0, 30)), bossTrack), Func(self.__showResistanceToon, False), Func(self.__showToons), Wait(1), Func(base.camera.wrtReparentTo, render), Func(base.camera.setPos, Point3(120, -280, 1)), Func(base.camera.setHpr, Point3(0, 0, 0)), Func(rToon.setChatAbsolute, TTL.ResistanceToonFollowHim, CFSpeech), Wait(2), Func(rToon.setHpr, Point3(180, 0, 0)), Func(rToon.animFSM.request, 'run'), rToon.posInterval(2, Point3(toonPosHpr[0], toonPosHpr[1], toonPosHpr[2])), Func(rToon.animFSM.request, 'neutral'), self.createWalkInInterval(), Wait(1), Func(rToon.clearChat), Func(base.camera.wrtReparentTo, self.geom), base.camera.posHprInterval(1, Point3(105, -326, 20), VBase3(-45.3, 15, 0), blendType='easeInOut'), Parallel(self.door2.posInterval(4.5, VBase3(0, 0, 0)), self.door3.posInterval(4.5, VBase3(0, 0, 0)), Sequence(Func(self.setChatAbsolute, TTL.CashbotBossTrapped, CFSpeech), Wait(4), Func(self.clearChat), Func(self.setChatAbsolute, TTL.CashbotBossCogAttack, CFSpeech), Wait(2), Func(self.setChatAbsolute, TTL.CashbotBossCogAgain, CFSpeech), Wait(2), Func(self.clearChat), Func(self.getGeomNode().setH, 0), Func(self.midCutsceneMusic.stop))))
    ...
    def makePrepareBattleThreeMovie(self, delayDeletes, crane, safe):
        ...
        crane = self.cranes[0]
        base.playMusic(self.midCutsceneMusic, looping=1, volume=0.9)
        track = Sequence(Func(self.__hideToons), Func(crane.request, 'Movie'), Func(crane.accomodateToon, rToon), Func(goon.request, 'Stunned'), Func(goon.setPosHpr, 104, -316, 0, 165, 0, 0), Func(rToon.loop, 'leverNeutral'), Func(base.camera.wrtReparentTo, self.geom), base.camera.posHprInterval(1.5, Point3(105, -326, 5), Point3(136.3, 0, 0), blendType='easeInOut'), Func(rToon.setChatAbsolute, TTL.ResistanceToonCraneInstructions1, CFSpeech), Wait(4), Func(rToon.setChatAbsolute, TTL.ResistanceToonCraneInstructions2, CFSpeech), Wait(4), Func(rToon.setChatAbsolute, TTL.ResistanceToonCraneInstructions3, CFSpeech), Wait(4), Func(rToon.setChatAbsolute, TTL.ResistanceToonCraneInstructions4, CFSpeech), Wait(4), Func(rToon.clearChat), base.camera.posHprInterval(1, Point3(102, -323.6, 0.9), VBase3(-10.6, 14, 0), blendType='easeInOut'), Func(goon.request, 'Recovery'), Wait(2), base.camera.posHprInterval(1, Point3(95.4, -332.6, 4.2), VBase3(167.1, -13.2, 0), blendType='easeInOut'), Func(rToon.setChatAbsolute, TTL.ResistanceToonGetaway, CFSpeech), Func(rToon.animFSM.request, 'jump'), Wait(1.8), Func(rToon.clearChat), base.camera.posHprInterval(1, Point3(109.1, -300.7, 13.9), VBase3(-15.6, -13.6, 0), blendType='easeInOut'), Func(rToon.animFSM.request, 'run'), Func(goon.request, 'Walk'), Parallel(self.door3.posInterval(3, VBase3(0, 0, 0)), rToon.posHprInterval(3, Point3(136, -212.9, 0), VBase3(-14, 0, 0), startPos=Point3(110.8, -292.7, 0), startHpr=VBase3(-14, 0, 0)), goon.posHprInterval(3, Point3(125.2, -243.5, 0), VBase3(-14, 0, 0), startPos=Point3(104.8, -309.5, 0), startHpr=VBase3(-14, 0, 0))), Func(self.__hideFakeGoons), Func(crane.request, 'Free'), Func(self.getGeomNode().setH, 0), self.moveToonsToBattleThreePos(self.involvedToons), Func(self.midCutsceneMusic.stop), Func(self.__showToons), Wait(2))
    ...
    def makeBossFleeMovie(self):
        ...
        bossTrack = Track((0.0, Sequence(Func(base.camera.reparentTo, render), Func(base.camera.setPosHpr, 105, -280, 20, -158, -3, 0), Func(self.reparentTo, render), Func(self.show), Func(self.clearChat), Func(self.setPosHpr, *ToontownGlobals.CashbotBossBattleThreePosHpr), ActorInterval(self, 'Fb_firstHit'), ActorInterval(self, 'Fb_down2Up'))), (1.0, Func(self.setChatAbsolute, hadEnough, CFSpeech)), (5.5, Parallel(Func(base.camera.setPosHpr, 100, -315, 16, -20, 0, 0), Func(self.hideBattleThreeObjects), Func(self.loop, 'Ff_neutral'), rollTrack, self.door3.posInterval(2.5, Point3(0, 0, 25), startPos=Point3(0, 0, 18)))), (5.5, Func(self.setChatAbsolute, outtaHere, CFSpeech)), (5.5, SoundInterval(trainPassingSfx)), (8.1, Func(self.clearChat)), (9.4, Sequence(Func(loco.reparentTo, render), Func(car1.reparentTo, render), Func(car2.reparentTo, render), trainTrack, Func(loco.detachNode), Func(car1.detachNode), Func(car2.detachNode), Wait(2))), (9.5, SoundInterval(flattenSfx)), (9.5, Sequence(self.scaleInterval(0.1, Point3(2, 2, 0.025)), Func(self.pose, 'Ff_neutral', 0))))
        return bossTrack
    ...
    def enterElevator(self):
        ...
        base.camLens.setMinFov(ToontownGlobals.CFOElevatorFov / (4.0 / 3.0))
