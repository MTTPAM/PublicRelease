...
class DistributedLawbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def loadEnvironment(self):
        ...
        self.promotionMusic = base.loadMusic('phase_11/audio/bgm/LB_CJ_Cutscene.ogg')
        self.battleOneMusic = base.loadMusic('phase_11/audio/bgm/LB_CJ_Battle_1.ogg')
        ...
        self.battleThreeMusic = base.loader.loadMusic('phase_11/audio/bgm/LB_CJ_Fight.ogg')
    ...
    def enterElevator(self):
        ...
        base.camLens.setMinFov(ToontownGlobals.CJElevatorFov / (4.0 / 3.0))
    ...
    def makeIntroductionMovie(self, delayDeletes):
        ...
        track = Parallel()
        bossAnimTrack = Sequence(ActorInterval(self, 'Ff_speech', startTime=2, duration=10, loop=1), ActorInterval(self, 'Ff_lookRt', duration=3), ActorInterval(self, 'Ff_lookRt', duration=3, startTime=3, endTime=0), ActorInterval(self, 'Ff_neutral', duration=2), ActorInterval(self, 'Ff_speech', duration=7, loop=1))
        track.append(bossAnimTrack)
        attackToons = TTLocalizer.BossCogAttackToons
        dialogTrack = Track((0, Func(self.setChatAbsolute, TTLocalizer.LawbotBossTempIntro0, CFSpeech)), (5.6, Func(self.setChatAbsolute, TTLocalizer.LawbotBossTempIntro1, CFSpeech)), (12, Func(self.setChatAbsolute, TTLocalizer.LawbotBossTempIntro2, CFSpeech)), (18, Func(self.setChatAbsolute, TTLocalizer.LawbotBossTempIntro3, CFSpeech)), (22, Func(self.setChatAbsolute, TTLocalizer.LawbotBossTempIntro4, CFSpeech)), (24, Sequence(Func(self.clearChat), self.loseCogSuits(self.toonsA + self.toonsB, render, (-2.798, -70, 10, 180, 0, 0)))), (27, Sequence(self.toonNormalEyes(self.involvedToons), Func(self.loop, 'Ff_neutral'), Func(self.setChatAbsolute, attackToons, CFSpeech))))
    ...
    def makeVictoryMovie(self):
        ...
        bossTrack = Track((0.5, Sequence(Func(self.clearChat), Func(base.camera.reparentTo, render), Func(base.camera.setPos, -3, 45, 25), Func(base.camera.setHpr, 0, 10, 0))), (1.0, Func(self.setChatAbsolute, TTLocalizer.LawbotBossDefenseWins1, CFSpeech)), (5.5, Func(self.setChatAbsolute, TTLocalizer.LawbotBossDefenseWins2, CFSpeech)), (9.5, Sequence(Func(base.camera.wrtReparentTo, render))), (9.6, Parallel(rollTrack, Func(self.setChatAbsolute, TTLocalizer.LawbotBossDefenseWins3, CFSpeech), self.door3.posInterval(2, doorEndPos, startPos=doorStartPos))), (13.1, Sequence(Parallel(SoundInterval(whistleSfx), Sequence(Func(self.setChatAbsolute, TTLocalizer.LawbotBossDefenseWins4, CFSpeech), LerpScaleInterval(self.dropShadow, 3, Point3(15, 15, 15)), Func(paperwork.reparentTo, render), Parallel(LerpPosInterval(paperwork, 0.1, paperToPos, startPos=paperPosStart), SoundInterval(dropSfx), Func(self.stash)), Func(paperwork.detachNode))))), (17, Sequence(self.door3.posInterval(1, doorStartPos))))
    ...
    def setAttackCode(self, attackCode, avId = 0):
        ...
        if attackCode == ToontownGlobals.BossCogAreaAttack:
            ...
            self.interruptMove()
            self.setDizzy(0)
            self.setAnimate('golf_swing', now=0)
