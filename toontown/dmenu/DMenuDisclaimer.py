#Embedded file name: toontown.dmenu.DMenuDisclaimer
...
class DMenuDisclaimer(DirectObject):
    ...
    def __init__(self):
        ...
        self.disclaimer = OnscreenText(text=disclaimerText, font=ToontownGlobals.getMinnieFont(), style=3, wordwrap=30, scale=0.08, pos=(0, 0.3, 0))
        ...
        self.accept = DirectButton(parent=aspect2d, relief=None, image=(yesUp, yesDown, yesUp), image_scale=(0.6, 0.6, 0.6), image1_scale=(0.7, 0.7, 0.7), image2_scale=(0.7, 0.7, 0.7), text=('', 'I Agree', 'I Agree'), text_pos=(0, -0.175), text_style=3, text_scale=0.08, pos=(0.4, 0, -0.5), command=self.accept)
        self.deny = DirectButton(parent=aspect2d, relief=None, image=(noUp, noDown, noUp), image_scale=(0.6, 0.6, 0.6), image1_scale=(0.7, 0.7, 0.7), image2_scale=(0.7, 0.7, 0.7), text=('', 'I Disagree', 'I Disagree'), text_pos=(0, -0.175), text_style=3, text_scale=0.08, pos=(-0.4, 0, -0.5), command=self.deny)
