#Embedded file name: toontown.safezone.DistributedGameTable
import math
...
class DistributedGameTable(DistributedObject.DistributedObject):
    ...
    def __init__(self, cr):
        ...
        self.tutorial = None
        self.fsm = ClassicFSM.ClassicFSM('DistributedGameTable', [State.State('off', self.enterOff, self.exitOff, ['chooseMode', 'observing']),
    ...
    def tutorialButtonPushed(self):
        self.disableChoiceButtons()
        self.gameMenu = PicnicGameSelectMenu(self.tutorialFunction, PicnicGameGlobals.TutorialMenu)
