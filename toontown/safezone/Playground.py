...
class Playground(BattlePlace.BattlePlace):
    ...
    def __init__(self, loader, parentFSM, doneEvent):
        ...
        self.fsm = ClassicFSM.ClassicFSM('Playground', [State.State('start', self.enterStart, self.exitStart, ['walk',
          'deathAck',
          'doorIn',
          'tunnelIn']),
         State.State('walk', self.enterWalk, self.exitWalk, ['drive',
          'sit',
          'stickerBook',
          'TFA',
          'DFA',
         ...
         State.State('stickerBook', self.enterStickerBook, self.exitStickerBook, ['walk',
          ...
          'fishing',
          'trialerFA']),
         State.State('sit', self.enterSit, self.exitSit, ['walk', 'DFA', 'trialerFA']),
         State.State('drive', self.enterDrive, self.exitDrive, ['walk', 'DFA', 'trialerFA']),
         ...
         State.State('TFAReject', self.enterTFAReject, self.exitTFAReject, ['walk']),
         ...
         State.State('DFA', self.enterDFA, self.exitDFA, ['DFAReject', 'NPCFA', 'HFA']),
         State.State('DFAReject', self.enterDFAReject, self.exitDFAReject, ['walk']),
         State.State('NPCFA', self.enterNPCFA, self.exitNPCFA, ['NPCFAReject', 'HFA']),
         ...
         State.State('deathAck', self.enterDeathAck, self.exitDeathAck, ['teleportIn']),
         State.State('teleportIn', self.enterTeleportIn, self.exitTeleportIn, ['walk', 'popup']),
         State.State('popup', self.enterPopup, self.exitPopup, ['walk']),
         State.State('teleportOut', self.enterTeleportOut, self.exitTeleportOut, ['deathAck', 'teleportIn']),
         ...
         State.State('battle', self.enterBattle, self.exitBattle, ['walk', 'teleportOut', 'died'])], 'start', 'final')
    ...
    def enter(self, requestStatus):
        ...
        if base.config.GetBool('want-charity-screen', False):
            ...
            if self.zoneId in [ToontownGlobals.ToontownCentral,
