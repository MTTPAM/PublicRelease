...
class ToontownTimeManager(DistributedObject.DistributedObject):
    ...
    def __init__(self, serverTimeAtLogin = 0, clientTimeAtLogin = 0, realTimeAtLogin = 0):
        self.serverTimeZone = ToontownTimeZone()
        self.updateLoginTimes(serverTimeAtLogin, clientTimeAtLogin, realTimeAtLogin)

    def updateLoginTimes(self, serverTimeAtLogin, clientTimeAtLogin, realTimeAtLogin):
        self.serverTimeAtLogin = serverTimeAtLogin
        self.clientTimeAtLogin = clientTimeAtLogin
        self.realTimeAtLogin = realTimeAtLogin
        self.serverDateTime = datetime.fromtimestamp(self.serverTimeAtLogin, self.serverTimeZone)
