#Embedded file name: toontown.coghq.boardbothq.DistributedBoardOfficeElevatorExt
...
class DistributedBoardOfficeElevatorExt(DistributedElevatorExt.DistributedElevatorExt):
    ...
    def getDestName(self):
        ...
        if self.boardofficeId == ToontownGlobals.BoardOfficeIntB:
            return 'Board Office 2'
        if self.boardofficeId == ToontownGlobals.BoardOfficeIntC:
