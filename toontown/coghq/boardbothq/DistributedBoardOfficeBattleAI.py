#Embedded file name: toontown.coghq.boardbothq.DistributedBoardOfficeBattleAI
...
class DistributedBoardOfficeBattleAI(DistributedLevelBattleAI.DistributedLevelBattleAI):
    ...
    def handleToonsWon(self, toons):
        ...
        for toon in toons:
            ...
            if self.bossBattle:
                self.toonParts[toon.doId] = self.air.cogSuitMgr.recoverPart(toon, 'fullSuit', self.suitTrack, self.getTaskZoneId(), toons)
