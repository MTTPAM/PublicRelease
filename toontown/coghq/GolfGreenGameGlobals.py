#Embedded file name: toontown.coghq.GolfGreenGameGlobals
gameBoards = [('rbygl', 'r_______b', 'byyywgggr', 'r_______b', 'bggyyyggr', 'r_______b', 'byylllyyr', 'r_______b', 'Blllllllr'),
