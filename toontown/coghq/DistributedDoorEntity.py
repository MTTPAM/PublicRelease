...
class DistributedDoorEntity(DistributedEntity.DistributedEntity, FourState.FourState, VisibilityBlocker.VisibilityBlocker, DistributedDoorEntityBase.DistributedDoorEntityBase, BasicEntities.NodePathAttribsProxy):
    ...
    def setupDoor(self):
        ...
        if model:
            ...
            self.node = rootNode
            self.node.show()
            self.locks.append(DistributedDoorEntityLock(self, 0, doorway.find('**/Slide_One_Closed'), doorway.find('**/Slide_One_Left_Open'), doorway.find('**/Slide_One_Right_Open'), self.initialLock0StateIndex))
            self.locks.append(DistributedDoorEntityLock(self, 1, doorway.find('**/Slide_Two_Closed'), doorway.find('**/Slide_Two_Left_Open'), doorway.find('**/Slide_Two_Right_Open'), self.initialLock1StateIndex))
            self.locks.append(DistributedDoorEntityLock(self, 2, doorway.find('**/Slide_Three_Closed'), doorway.find('**/Slide_Three_Left_Open'), doorway.find('**/Slide_Three_Right_Open'), self.initialLock2StateIndex))
