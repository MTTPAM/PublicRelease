#Embedded file name: toontown.coghq.DistributedMoleField
...
class DistributedMoleField(DistributedNodePathEntity, MoleFieldBase.MoleFieldBase):
    ...
    def loadGui(self):
        self.frame2D = DirectFrame(scale=1.0, pos=(0.0, 0, 0.9), relief=DGG.FLAT, parent=aspect2d, frameSize=(-0.3, 0.3, -0.05, 0.05), frameColor=(0.737, 0.573, 0.345, 0.3))
