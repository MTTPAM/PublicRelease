#Embedded file name: toontown.coghq.DistributedCashbotBossCrane
import random
...
class DistributedCashbotBossCrane(DistributedObject.DistributedObject, FSM.FSM):
    ...
    def __enableControlInterface(self):
        ...
        self.closeButton = DirectButton(parent=base.a2dBottomRight, image=(gui.find('**/CloseBtn_UP'),
         gui.find('**/CloseBtn_DN'),
         gui.find('**/CloseBtn_Rllvr'),
         gui.find('**/CloseBtn_UP')), relief=None, scale=2, text=TTLocalizer.CashbotCraneLeave, text_scale=0.04, text_pos=(0, -0.07), text_fg=VBase4(1, 1, 1, 1), pos=(-0.25, 0, 0.175), command=self.__exitCrane)
