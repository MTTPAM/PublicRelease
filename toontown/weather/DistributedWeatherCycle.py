#Embedded file name: toontown.weather.DistributedWeatherCycle
...
class DistributedWeatherCycle(DistributedObject):
    ...
    def __init__(self, cr):
        ...
        self.fsm = ClassicFSM(self.__class__.__name__, [State('off', self.enterOff, self.exitOff, ['morning']),
    ...
    def enterMorning(self):
        self.__interval = LerpColorScaleInterval(render, self.getDuration(), WeatherGlobals.cycleColors[0], startColorScale=render.getColorScale())
    ...
    def enterAfternoon(self):
        self.__interval = LerpColorScaleInterval(render, self.getDuration(), WeatherGlobals.cycleColors[1], startColorScale=render.getColorScale())
        self.__interval.start()
    ...
    def enterEvening(self):
        self.__interval = LerpColorScaleInterval(render, self.getDuration(), WeatherGlobals.cycleColors[2], startColorScale=render.getColorScale())
        self.__interval.start()
    ...
    def enterMidnight(self):
        self.__interval = LerpColorScaleInterval(render, self.getDuration(), WeatherGlobals.cycleColors[3], startColorScale=render.getColorScale())
        self.__interval.start()
