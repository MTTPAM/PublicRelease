#Embedded file name: toontown.building.TutorialBuildingAI
...
class TutorialBuildingAI:
    ...
    def __init__(self, air, exteriorZone, interiorZone, blockNumber, tutorialNpcId):
        ...
        self.interior = DistributedTutorialInteriorAI(self.air, self.blockNumber, self.interiorZone, self.tutorialNpcId)
        self.interior.generateWithRequired(self.interiorZone)
        self.door = DistributedDoorAI.DistributedDoorAI(self.air, blockNumber, DoorTypes.EXT_STANDARD)
        self.insideDoor = DistributedDoorAI.DistributedDoorAI(self.air, blockNumber, DoorTypes.INT_STANDARD)
