#Embedded file name: toontown.makeatoon.MakeAToon
...
class MakeAToon(StateData.StateData):
    ...
    def load(self):
        ...
        ee = DirectFrame(pos=(-1, 1, 1), frameSize=(-0.01, 0.01, -0.01, 0.01), frameColor=(0, 0, 0, 0.05), state='normal')
    ...
    def enterBodyShop(self):
        ...
        if BODYSHOP not in self.shopsVisited:
            ...
            if not self.toonRotateSlider:
                ...
                self.toonRotateSliderRotationText = OnscreenText('0.0', scale=0.1, pos=(0, 0.1), fg=(1, 1, 1, 1), style=3)
