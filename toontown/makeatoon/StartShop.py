#Embedded file name: toontown.makeatoon.StartShop
    ...
    def load(self):
        ...
        for trackId in xrange(len(ToontownBattleGlobals.Tracks)):
            ...
            if trackId == 4 or trackId == 5:
                button = DirectButton(parent=self.gagFrame, image=iconGeom, relief=None, pos=(0, 0, 0.45 - buttonYOffset * trackId), image_color=(0.3, 0.3, 0.3, 1), state=DGG.DISABLED)
                button2 = DirectButton(parent=self.gagFrame, image=iconGeom, relief=None, pos=(buttonXOffset, 0, 0.45 - buttonYOffset * trackId), image_color=(0.3, 0.3, 0.3, 1), state=DGG.DISABLED)
            else:
                button = DirectButton(parent=self.gagFrame, image=iconGeom, relief=None, pos=(0, 0, 0.45 - buttonYOffset * trackId), command=self.chooseGag, extraArgs=[trackId])
                button2 = DirectButton(parent=self.gagFrame, image=iconGeom, relief=None, pos=(buttonXOffset, 0, 0.45 - buttonYOffset * trackId), command=self.chooseGag, extraArgs=[trackId, 1])
