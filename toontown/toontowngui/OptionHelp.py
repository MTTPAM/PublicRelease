#Embedded file name: toontown.toontowngui.OptionHelp
...
class OptionHelp(DirectFrame):
    ...
    def __init__(self, parent = aspect2d, moviePath = None, helpText = None, **kw):
        ...
        self.helpText = DirectLabel(parent=self, relief=None, text=helpText, pos=(0, 0, -0.1), text_align=TextNode.ALeft, text_wordwrap=16, text_scale=0.05)
