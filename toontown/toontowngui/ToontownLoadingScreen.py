...
class ToontownLoadingScreen:
    ...
    def __init__(self):
        ...
        self.tip = DirectLabel(guiId='ToontownLoadingScreenTip', parent=self.gui, relief=None, pos=(0, 0, 0.5), text='', textMayChange=1, text_scale=0.05, text_fg=(1, 1, 1, 1), text_shadow=(0, 0, 0, 1), text_wordwrap=40, text_align=TextNode.ACenter, text_font=ToontownGlobals.getMinnieFont())
        self.waitBar = DirectWaitBar(guiId='ToontownLoadingScreenWaitBar', parent=self.gui, frameSize=(base.a2dLeft + base.a2dRight / 4.95,
         base.a2dRight - base.a2dRight / 4.95,
         -0.04,
         0.04), pos=(0, 0, 0.15), text='')
        logoScale = 0.3625
    ...
    def begin(self, range, label, gui, tipCategory, zoneId):
        self.zone2background = {ToontownGlobals.ToontownCentral: 'ttc.jpg',
        ...
        self.zone2fontcolor = {ToontownGlobals.GoofySpeedway: VBase4(ToontownGlobals.GSCOLOR),
