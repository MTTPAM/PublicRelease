#Embedded file name: toontown.touch.TouchControls
...
class TouchControls(DirectFrame, DirectObject):
    ...
    def __init__(self):
        ...
        self.upButton = DirectButton(parent=self, relief=None, text_style=3, image=fwd, image_scale=0.1, text_fg=(1, 1, 1, 1), text='', scale=1.2)
        self.downButton = DirectButton(parent=self, relief=None, text_style=3, image=down, image_scale=0.1, text_fg=(1, 1, 1, 1), text='', scale=1.2)
        self.leftButton = DirectButton(parent=self, relief=None, text_style=3, image=left, image_scale=0.1, text_fg=(1, 1, 1, 1), text='', scale=1.2)
        self.rightButton = DirectButton(parent=self, relief=None, text_style=3, image=right, image_scale=0.1, text_fg=(1, 1, 1, 1), text='', scale=1.2)
        self.jumpButton = DirectButton(parent=base.a2dBottomRight, relief=None, text_style=3, image=jump, image_scale=0.1, text_fg=(1, 1, 1, 1), text='', scale=1.2)
        ...
        self.upButton.setPos(0, 0, 0.2)
        self.downButton.setPos(0, 0, -0.2)
        self.leftButton.setPos(-0.2, 0, 0)
        self.rightButton.setPos(0.2, 0, 0)
        self.jumpButton.setPos(-0.5, 0, 0.5)
