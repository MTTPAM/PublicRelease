#Embedded file name: toontown.minigame.DistributedPhotoGame
...
class DistributedPhotoGame(DistributedMinigame, PhotoGameBase.PhotoGameBase):
    ...
    def __doZoom(self):
        ...
        if self.zoomedView:
            ...
            zoomTrack.append(LerpFunc(base.camLens.setMinFov, fromData=self.outFov / (4.0 / 3.0), toData=self.zoomFov / (4.0 / 3.0), duration=ZOOMTIME))
            ...
            zoomTrack = Parallel()
            zoomTrack.append(LerpQuatInterval(self.swivel, ZOOMTIME, newQuat))
            zoomTrack.append(LerpFunc(base.camLens.setMinFov, fromData=self.zoomFov / (4.0 / 3.0), toData=self.outFov / (4.0 / 3.0), duration=ZOOMTIME))
