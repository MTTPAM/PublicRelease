#Embedded file name: toontown.minigame.DistributedTugOfWarGame
...
class DistributedTugOfWarGame(DistributedMinigame):
    ...
    def sendGameType(self, index, suit):
        ...
        if suit == 1:
            ...
            self.suitType = random.choice(['ym',
             'mm',
             'dt',
             'ac',
             'tw',
            ...
            self.suitType = random.choice(['ds',
             'hh',
             'bs',
             'sd',
             'nc',
            ...
            self.suitType = random.choice(['cr',
             'tbc',
             'le',
             'bw',
             'ls',
