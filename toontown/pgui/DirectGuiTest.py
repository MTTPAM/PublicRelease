#Embedded file name: toontown.pgui.DirectGuiTest
__all__ = []
if __name__ == '__main__':
    ...
    dbArray = []
    for i in range(10):
        db = DirectButton(parent=dl, image='models/maps/noise.rgb', geom=smiley, text=('Hi!', 'Ouch!', 'Bye!', 'ZZZZ!'), scale=0.15, relief='raised', geom1_color=Vec4(1, 0, 0, 1), text_pos=(0.6, -0.8), clickSound=DirectGuiGlobals.getDefaultClickSound(), rolloverSound=DirectGuiGlobals.getDefaultRolloverSound())
        db['text_scale'] = 0.5
