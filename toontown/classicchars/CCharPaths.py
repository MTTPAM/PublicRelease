...
def getPaths(charName, location = 0):
    ...
    if charName == TTLocalizer.Goofy:
        ...
        if charName == TTLocalizer.Chip or charName == TTLocalizer.PoliceChip:
            return __chipPaths
        if charName == TTLocalizer.Dale or charName == TTLocalizer.JailbirdDale:
            return __chipPaths
...
def __getWaypointList(paths):
    ...
    if paths == __chipPaths:
        return __chipWaypoints
    if paths == __dalePaths:
        return __chipWaypoints
