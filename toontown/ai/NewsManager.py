        ...
        for holidayItem in self.relativelyCalendarHolidays:
            ...
            while i < len(item):
                ...
                while 1:
                    ...
                    if nDay > sDay and item[i + 1][0] == item[i][0] and item[i + 1][1] - item[i][1] <= (nDay - sDay + abs(eWeekday - sWeekday)) / 7 or item[i + 1][0] != item[i][0]:
                        break
                ...
                newItem.append([item[i][0],
                 sDay,
                 item[i][3],
                 item[i][4],
                 item[i][5]])
                newItem.append([item[i + 1][0],
                 nDay,
                 item[i + 1][3],
                 item[i + 1][4],
                 item[i + 1][5]])
