#Embedded file name: otp.otpgui.LoadingDialog
...
class LoadingDialog:
    ...
    def __init__(self):
        ...
        self.loadingText = OnscreenText(parent=aspect2d, text='Connecting...', font=ToontownGlobals.getMinnieFont(), style=3, align=TextNode.ACenter, scale=0.1, pos=(0, -0.8))
        ...
        self.logo = OnscreenImage(parent=base.a2dTopCenter, image='phase_3/maps/toontown-logo.png', scale=(1.0, 1, 0.5), pos=(0, 0, -0.85))
    ...
    def start(self, text = 'Connecting...'):
        ...
        self.Seq = Sequence(Func(self.loadingCircle.setHpr, VBase3(0, 0, 0)), self.loadingCircle.hprInterval(1, VBase3(0, 0, 360)))
        self.Seq.loop()
