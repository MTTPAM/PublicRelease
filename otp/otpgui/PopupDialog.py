#Embedded file name: otp.otpgui.PopupDialog
...
class PopupDialog:
    ...
    def __init__(self):
        ...
        self.dialogText = OnscreenText(text='put text here', font=ToontownGlobals.getMinnieFont(), style=3, align=TextNode.ACenter, scale=0.1, pos=(0, 0.2, 0), wordwrap=20)
        ...
        self.yesButton = DirectButton(relief=None, text_style=3, image=(shuffleUp, shuffleDown, shuffleUp), image_scale=(0.8, 0.7, 0.7), image1_scale=(0.83, 0.7, 0.7), image2_scale=(0.83, 0.7, 0.7), text_fg=(1, 1, 1, 1), text='Yes', text_pos=(0, -0.02), text_scale=0.08, scale=0.95, command=self.doYesButton)
        self.yesButton.reparentTo(aspect2d)
        self.yesButton.setPos(0, 0, -0.4)
        self.noButton = DirectButton(relief=None, text_style=3, image=(shuffleUp, shuffleDown, shuffleUp), image_scale=(0.8, 0.7, 0.7), image1_scale=(0.83, 0.7, 0.7), image2_scale=(0.83, 0.7, 0.7), text_fg=(1, 1, 1, 1), text='No', text_pos=(0, -0.02), text_scale=0.08, scale=0.95, command=self.doNoButton)
        self.noButton.reparentTo(aspect2d)
        self.noButton.setPos(0, 0, -0.6)
