...
OFFENSE_MSGS = ('-- DEV CHAT -- blocked blacklisted word!', 'Watch your language! This is your first offense.', "Watch your language! This is your second offense. Next offense you'll get banned for 24 hours.")
...
class ChatAgentUD(DistributedObjectGlobalUD):
    ...
    def chatMessage(self, message, chatMode):
        ...
        if chatMode != 0:
            ...
            modifications = []
        self.sendUpdate('chatMessageResponse', [sender,
         cleanMessage,
         modifications,
         chatMode])
    ...
    def updateAvatarOffenses(self, sender, count):
        avId = sender & 4294967295L
        if sender not in self.offenses:
