#Embedded file name: otp.chat.ChatAgentAI
...
class ChatAgentAI(DistributedObjectGlobalAI):
    ...
    def chatMessageResponse(self, sender, message, modifications, chatMode):
        ...
        if not av:
            return
        av.b_setTalk(sender, self.chatMode2channel.get(chatMode, sender), av.getName(), message, modifications, CFSpeech | CFQuicktalker | CFTimeout)
