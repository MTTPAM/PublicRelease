...
class PrivacyPolicyTextPanel(getGlobalDialogClass()):
    ...
    def __init__(self, doneEvent, hidePageNum = 0, pageChangeCallback = None, textList = []):
        ...
        dialogClass.__init__(self, parent=aspect2d, dialogName='privacyPolicyTextDialog', doneEvent=doneEvent, okButtonText=OTPLocalizer.PrivacyPolicyClose, style=OTPDialog.Acknowledge, text='', topPad=1.5, sidePad=1.2, pos=(0, 0, -0.55), scale=0.9)
...
class PrivacyPolicyPanel(getGlobalDialogClass()):
    ...
    def __init__(self, doneEvent, hidePageNum = 0, pageChangeCallback = None, textList = 1):
        dialogClass = getGlobalDialogClass()
        dialogClass.__init__(self, parent=aspect2d, dialogName='privacyPolicyDialog', doneEvent=doneEvent, okButtonText=OTPLocalizer.PrivacyPolicyClose, style=OTPDialog.Acknowledge, text='', topPad=1.5, sidePad=1.2, pos=(0, 0, -0.15), scale=0.6)
