#Embedded file name: otp.distributed.ConnectionRepository_override
...
class ConnectionRepository_override(DoInterestManager, DoCollectionManagerOR, CConnectionRepository):
    ...
    def __init__(self, connectMethod, config, hasOwnerView = False, threadedNet = None, dcStream = None):
        ...
        if self.config.GetBool('want-garbage-collect-task', 1):
            ...
            taskMgr.doMethodLater(self.config.GetFloat('garbage-threshold-adjust-delay', 300.0), self._adjustGcThreshold, self.GarbageThresholdTaskName)
    ...
    def _adjustGcThreshold(self, task):
        ...
        if numGarbage == 0:
            ...
            gc.set_threshold(min(a * 2, 1073741824), b, c)
