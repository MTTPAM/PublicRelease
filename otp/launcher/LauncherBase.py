...
class LauncherBase(DirectObject):
    ...
    def decreaseBandwidth(self, targetBandwidth = None):
        if not self.DECREASE_BANDWIDTH:
            return 0
        elif self.backgrounded and self.everIncreasedBandwidth:
            return 0
        elif self.bandwidthIndex == 0:
            return 0
        else:
            self.bandwidthIndex -= 1
            if targetBandwidth:
    ...
    def scanForHacks(self):
        ...
        knownHacksRegistryKeys = {hackName[0]: [[_winreg.HKEY_LOCAL_MACHINE, 'Software\\Microsoft\\Windows\\CurrentVersion\\Run\\!xSpeed'],
         ...
         hackName[1]: [[_winreg.HKEY_CURRENT_USER, 'Software\\aspeeder'], [_winreg.HKEY_LOCAL_MACHINE, 'Software\\aspeeder'], [_winreg.HKEY_LOCAL_MACHINE, 'Software\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\aspeeder']]}
        try:
        ...
        knownHacksMUI = {'!xspeednet': hackName[0],
         'aspeeder': hackName[1],
        ...
        try:
            ...
            knownHacksExe = {'!xspeednet.exe': hackName[0],
