...
CRLostConnection = 'Oh darn, you have disconnected!'
CRBootedReasons = {1: 'An unexpected problem has occurred.  Your connection has been lost, but you should be able to connect again and go right back into the game.',
 ...
 153: 'Great job! You have successfully reset the entire district! CONGRATULATIONS I HOPE YOU ARE PROUD OF YOURSELF!',
...
EmoteWhispers = ['%s waves.',
 ...
 '%s does a belly flop.',
 '%s bows to you.',
 '%s slips and slides on a banana peel.',
...
SuitBrushOffs = {'f': ["I'm late for a meeting."],
 ...
 None: ["I'll screw you over toon!",
        "Get outta my face toon!",
        'Go away.',
        "You'll regret this encounter.",
        'I hate you go away.',
...
SuitFaceoffTaunts = {'b': ['Do you have a donation for me?',
 ...
 'm': ['I plan on making this inconvenient for you.',
 ...
 'sw': ["I'm always swindling from the bottom to the top.", 'It sure is a nice day for some swindling.', 'Swindling is my favorite pasttime.'],
 'ms': ['I mean, this should work.',
        'When I fought this last toon, this worked, so it should work this time.',
        'I\'m in control!'
        ...
        'Are you shaking yet?',
        "Don't you know how to code in python?"],
 'hh': ["'Zere are many cons to fighting me, but 'zey only affect you.",
        "You're painting your future, yes?",
        "'Zere are many cons to fighting me, but 'zey only affect you.",
        "'Zere are many cons to fighting me, but 'zey only affect you.",
        "'Zere are many cons to fighting me, but 'zey only affect you.",
 ...
 'tbc': ['Prepare for a Nuclear meltdown.',
         'My attacks are toxic to Toons.',
         'Are you sure?  I can be such a tease at times.',
         ...
         'My skin is as bright as your future.'
         "I hope I'm not too sharp for you.",
         'A Toon, you say? Tell me more.',
         'Great timing, I was just about to send my Flunkies.'],
 'hho': ['I am in control!',
         'Do you need to consult a Root User?',
         'You need adminstrative privileges to install this program.',
         'Every dealt with the likes of me?',
         ...
         'You need adminstrative privileges to install this program.',
         'Every dealt with the likes of me?'],
 'cr': ["I'm freaking huge!",
        "Any fin is possible if I don't trout myself.",
        ...
        'Time to sign over your assets.',
        "I won't feel gillty after defeating you."],
 'ca': ['Lemme copy this "Toon Deletion" code into my injector!',
        'I\'m going to Ctrl + C your fate!',
        'Let\'s see you Ctrl + Alt + Delete your way out of this one!',
        'You are gonna want to Alt + F4 away from me.',
        'Let\'s see you Ctrl + Alt + Delete your way out of this one!',
        'You are gonna want to Alt + F4 away from me.'],
 ...
 'txm': ['I\'m gonna wrangle you up.',
         'Draw... an array.',
         'Wanna dance the DOS-ey-doe?',
         'Home, home on the xrange!',
         'I\'m gonna wrangle you up.',
         'Draw... an array.',
         'Wanna dance the DOS-ey-doe?',
         'Home, home on the xrange!',
         'Wanna dance the DOS-ey-doe?'],
 'nc': ["Hee-haw!",
        "You're going to make me laugh? Haw!",
        "Boy, you're as stubborn as I am.",
        "Mules have NOTHING on me!",
        "Hee-haw!",
        "You're going to make me laugh? Haw!",
        "Boy, you're as stubborn as I am.",
        "Mules have NOTHING on me!",
        "Hee-haw!",
        "You're going to make me laugh? Haw!"],
 'cn': ["I say, a good ol' rowdy play is in order!", "You seem to be in a spot of bother, don't yer know!", 'Would ye like a glass of defeat?'],
 'ls': ['Prepare for a Nuclear meltdown.',
        'My attacks are toxic to Toons.',
        'Are you sure?  I can be such a tease at times.',
        "My leadership skils are rather 'toxic.'",
        "Some say my personality is quite 'explosive.'",
        ...
        'Careful, I am poisonous to Toons.',
        'My skin is as bright as your future.'],
 'mb': ["Careful, my legal isn't very tender.",
        'I soar, then I score.',
 ...
 'mg': ["Even 'Legal Eagle' is terrified of me.", 'Birds of a feather, let me win this fight altogether.', "I'm like a hawk, only filled with more danger."],
 ...
 'bfh': ['Would you like to install the B.O.L.T.S. taskbar to Intoonet Explorer?',
         'Have you read the terms and conditions?',
         'Am I sure I want to uninstall this toon? YES.',
         'Check "Yes" to delete this toon.',
         'Would you like to install the B.O.L.T.S. taskbar to Intoonet Explorer?',
         'Have you read the terms and conditions?',
         'Am I sure I want to uninstall this toon? YES.'],
 'bs': ['Prepare for a Nuclear meltdown.',
        'My attacks are toxic to Toons.',
        "Some say my personality is quite 'explosive.'",
        "My leadership skils are rather 'toxic.'",
        'I\'ve got my "ion" you, toon.',
        ...
        'Are you ready to drink acid?',
        "My eyes are on you."],
 'bw': ["The boss will be impressed if I defeat you.",
        ...
        "I'm going to put you in jail toon!",
        "I'm a big deal little toon."],
 'le': ["This doesn't seem very legal to me.",
        'I will head you.',
        ...
        "I've got the court under my cage."],
 'sd': ["Even 'Legal Eagle' is terrified of me.",
        'I soar, then I score.',
        "I'm bringing down the law on you.",
 ...
 'f': ["Any fin is possible if I don't trout myself.",
       "You're just fishing for trouble.",
       'You will find me swimming in cash.',
       "I won't feel gillty after defeating you.",
       "I'm bigger than any fish you will ever catch.",
       "Something's rather fishy in here. No, it's just me!",
       "I'm a Small Fish in a Big pond, toon.", 
 ...
 'mm': ["Any fin is possible if I don't trout myself.",
        "You're just fishing for trouble.",
        'You will find me swimming in cash.',
        "I won't feel gillty after defeating you.",
        "I'm bigger than any fish you will ever catch.",
        "Something's rather fishy in here. No, it's just me!",
        "I'm a Medium Fish in a Medium pond, toon.",
        "I'll take care of you in no time.",
        "I'm watching every move you make.",
        ...
        'I can be very intimidating.',
        "I've been searching for my growth spurt."],
 'ds': ["Whether you're left or right, I'll always be in the middle.",
 ...
 'cc': ['In my opinion, your name is mud.',
 ...
 'mdm': ["I'm going to pump you full of LED.",
         "You're going to bite the bullet.",
         'This code is locked and loaded.',
         'Looks like you are in the crosshairs.',
         'I am a real straight shooter.'
         'This code is locked and loaded.',
         'Looks like you are in the crosshairs.',
         'I am a real straight shooter.'],
 'tm': ['I plan on making this inconvenient for you.',
        ...
        "I'm going to use up a lot of your resources."],
 'nd': ["I'm hot!",
        "You won't be mingling with me.",
        'I am going to mingle in your business.',
        "I'm The Mingler, but you can call me a slut.",
        'I have lots of boyfriends.',
        'I will get into your pants.',
 ...
 'tf': ["I'm too buff for your likings.",
        "You look like you could use some muscle.",
        "I'm too buff for this kids game.",
        "FLEX",
        "Do you lift?",
        "It's Shark Week.",
        'My muscles are jawdropping.',
        "I'm too buff for your likings.",
        "You look like you could use some muscle.",
        "I'm too buff for this kids game.",
        "FLEX",
        "Do you lift?"],
 'dt': ["I'm always swindling from the bottom to the top.",
        'It sure is a nice day for some swindling.',
        'Swindling is my favorite pasttime.',
        "It's time to do some swindling.",
        'I plan to do some swindling.',
        "You're not going to like my swindle.",
        'You may want to go away.',
        'I will take everything you own.',
        'I will swindle you from top to bottom.',
        'Swindling anyone??'],
...
SpeedChatStaticTextToontown = {100: 'Hi!',
 ...
 104: 'Howdy!',
 105: 'Hi everybody!',
 106: 'Welcome to Mr. Ts Toontown:Project Altis Modifications!',
 107: "What's up?",
 ...
 1114: "Let's go to Executivebot HQ!",
 1115: "Let's go fight the C.E.O.!",
 1116: "Let's go in the Factory!",
 1117: "Let's go fishing!",
 1118: "Let's go fishing at my house!",
 1119: "Let's go to Vaultbot HQ!",
 1120: "Let's go fight the V.S.S..!",
 1121: "Let's go in the Mint!",
 1122: "Let's go to Politibot HQ!",
 ...
 1127: "Let's go to Boardbot HQ!",
 1128: "Let's go fight the Chairman!",
 1129: "Let's go in the Cog Golf Courses!",
 1130: "Let's go to Techbot HQ!",
 1131: "Let's go fight the non existent boss!",
 ...
 1207: 'I need more Executivebot Suit Parts.',
 ...
 1214: 'I need more Vaultbot Suit Parts.',
 1215: 'I need more Politibot Suit Parts.',
 1216: 'I need more Boardbot Suit Parts.',
 1217: 'I need more Techbot Suit Parts.',
 ...
 5103: "Let's go to the Chairman Battle.",
 5104: "Let's go to the C.E.O. Battle.",
 ...
 5110: "Let's go to the V.S.S. Battle.",
 5111: "Let's go to the Chief Justice Battle.",
 5112: "Let's go to the Politibot A Office.",
 5113: "Let's go to the Politibot B Office.",
 5114: "Let's go to the Politibot C Office.",
 5115: "Let's go to the Politibot D Office.",
 5200: "We're going to the Front Three.",
 5201: "We're going to the Middle Six.",
 5202: "We're going to the Back Nine.",
 5203: "We're going to the Chairman Battle.",
 5204: "We're going to the C.E.O. Battle.",
 ...
 5210: "We're going to the V.S.S. Battle.",
 5211: "We're going to the Chief Justice Battle.",
 5212: "We're going to the Politibot A Office.",
 5213: "We're going to the Politibot B Office.",
 5214: "We're going to the Politibot C Office.",
 5215: "We're going to the Politibot D Office.",
